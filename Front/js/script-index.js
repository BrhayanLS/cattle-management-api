...
documentFragment.appendChild(document.createElement('tbody')); // Cerramos el tbody
table.appendChild(documentFragment); // Añadimos el fragmento de documento a la tabla
